...
Domain::Domain(Int_t numRanks, Index_t colLoc,
   ...
   inst(inst),
   world(world),
   m_x(inst, world, nodes, overlapping, overlapping, LAIK_RO_Min),
   m_y(inst, world, nodes, overlapping, overlapping, LAIK_RO_Min),
   m_z(inst, world, nodes, overlapping, overlapping, LAIK_RO_Min),
   m_xd(inst, world, nodes, overlapping, overlapping, LAIK_RO_Min),
   m_yd(inst, world, nodes, overlapping, overlapping, LAIK_RO_Min),
   m_zd(inst, world, nodes, overlapping, overlapping, LAIK_RO_Min),
   ...
   m_delv_xi(inst, world, elems, exclusive, halo),
   m_delv_eta(inst, world, elems, exclusive, halo),
   m_delv_zeta(inst, world, elems, exclusive, halo),
   m_delx_xi(inst, world, elems, exclusive, halo),
   m_delx_eta(inst, world, elems, exclusive, halo),
   m_delx_zeta(inst, world, elems, exclusive, halo),
   m_element_test(inst, world, elems, exclusive, halo),
   m_lxim(inst, world, elems, exclusive, halo),
   m_lxip(inst, world, elems, exclusive, halo),
   m_letam(inst, world, elems, exclusive, halo),
   m_letap(inst, world, elems, exclusive, halo),
   m_lzetam(inst, world, elems, exclusive, halo),
   m_lzetap(inst, world, elems, exclusive, halo),
   m_elemBC(inst, world, elems, exclusive, halo),
   m_e(inst, world, elems, exclusive, halo),
   m_p(inst, world, elems, exclusive, halo),
   m_q(inst, world, elems, exclusive, halo),
   m_ql(inst, world, elems, exclusive, halo),
   m_qq(inst, world, elems, exclusive, halo),
   m_v(inst, world, elems, exclusive, halo),
   m_volo(inst, world, elems, exclusive, halo),
   m_vnew(inst, world, elems, exclusive, halo),
   m_delv(inst, world, elems, exclusive, halo),
   m_vdov(inst, world, elems, exclusive, halo),
   m_arealg(inst, world, elems, exclusive, halo),
   m_ss(inst, world, elems, exclusive, halo),
   m_elemMass(inst, world, elems, exclusive, halo),
