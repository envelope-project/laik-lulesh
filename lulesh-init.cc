...
Domain::Domain(Int_t numRanks, Index_t colLoc,
   ...
   inst(inst),
   world(world),
   m_x(inst, world, LAIK_RO_Min),
   m_y(inst, world, LAIK_RO_Min),
   m_z(inst, world, LAIK_RO_Min),
   m_xd(inst, world, LAIK_RO_Min),
   m_yd(inst, world, LAIK_RO_Min),
   m_zd(inst, world, LAIK_RO_Min),
   m_xdd(inst, world, LAIK_RO_Min),
   m_ydd(inst, world, LAIK_RO_Min),
   m_zdd(inst, world, LAIK_RO_Min),
   m_fx(inst, world),
   m_fy(inst, world),
   m_fz(inst, world),
   ...
   m_delx_xi(inst, world),
   m_delx_eta(inst, world),
   m_delx_zeta(inst, world),
