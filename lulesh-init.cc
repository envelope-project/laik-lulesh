...
Domain::Domain(Int_t numRanks, Index_t colLoc,
   ...
   m_xd(inst, world, nodes, overlapping, overlapping, transitionToOverlappingInit, transitionToOverlappingReduce, LAIK_RO_Min),
   m_yd(inst, world, nodes, overlapping, overlapping, transitionToOverlappingInit, transitionToOverlappingReduce, LAIK_RO_Min),
   m_zd(inst, world, nodes, overlapping, overlapping, transitionToOverlappingInit, transitionToOverlappingReduce, LAIK_RO_Min),
   ...
   m_lxim(inst, world, elems, exclusive, halo, transitionToExclusive, transitionToHalo),
   m_lxip(inst, world, elems, exclusive, halo, transitionToExclusive, transitionToHalo),
   m_letam(inst, world, elems, exclusive, halo, transitionToExclusive, transitionToHalo),
   m_letap(inst, world, elems, exclusive, halo, transitionToExclusive, transitionToHalo),
   m_lzetam(inst, world, elems, exclusive, halo, transitionToExclusive, transitionToHalo),
   m_lzetap(inst, world, elems, exclusive, halo, transitionToExclusive, transitionToHalo),
   m_elemBC(inst, world, elems, exclusive, halo, transitionToExclusive, transitionToHalo),
   ...
   m_ql(inst, world, elems, exclusive, halo, transitionToExclusive, transitionToHalo),
